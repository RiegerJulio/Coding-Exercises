    ...
    Plants.prototype.getPlants = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile(this.plantsFile, { encoding: 'utf8' })];
                    case 1:
                        plantsRaw = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, promises_1.default.writeFile(this.plantsFile, JSON.stringify(newPlants))];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, promises_1.default.writeFile(this.plantsFile, JSON.stringify(updatedPlants))];
                    case 2:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, promises_1.default.readFile(this.opsFile, { encoding: 'utf8' })];
                    case 2:
                        opsInfoRaw = _a.sent();
                        createdPlants = JSON.parse(opsInfoRaw).createdPlants;
                        createdPlants += 1;
                        return [4 /*yield*/, promises_1.default.writeFile(this.opsFile, JSON.stringify({ createdPlants: createdPlants }))];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, promises_1.default.writeFile(this.plantsFile, JSON.stringify(plants))];
                    case 4:
                        _a.sent();
                        return [2 /*return*/, newPlant];
                }
